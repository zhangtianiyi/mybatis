		...
		<jsp:useBean id="loginBean" class="model.UserSession" scope="session"/>
 	    <% request.setCharacterEncoding("UTF-8"); %>
 			<ul class="user">
    			<li>
    				<%
    				    String username = loginBean.getCname();
    					if(username == null){
    			...
    			<font class="good" color=gray> 商品关键字如：鞋 衣 裤 书 手机 </font>
				    <div class="search-box">
				        <form class="search-form" name="formname" action="" target="_self" id="search-form" method="post">
				            ...
				            <input type="submit" onclick="document.formname.action='/TaoBaoApp/control/HandleGoodsServlet?key=3'" class="search-button" value="搜索商品"/>
				            <input type="submit" onclick="document.formname.action='/TaoBaoApp/control/HandleStoreServlet?key=3'" class="search-button2" value="搜索店铺"/>
				        </form>
				    </div>
			    <br />
